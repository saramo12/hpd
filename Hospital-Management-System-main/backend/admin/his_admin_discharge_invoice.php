                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Discharge Invoices</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Discharge Invoices</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                        ...
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th data-toggle="true">Invoices Name</th>
                                                <th data-hide="phone">Invoices Number</th>
                                                <th data-hide="phone">Invoices Address</th>
                                                <th data-hide="phone">Invoices Category</th>
                                                ...
                                                <td>
                                                    <a href="his_admin_discharge_single_patient.php?pat_id=<?php echo $row->pat_id;?>"
                                                        class="badge badge-primary"><i
                                                            class="mdi mdi-check-box-outline "></i> Discharge</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <?php  $cnt = $cnt +1 ; }?>
